...
const projects = [
  ...
  {
    id: 4,
    title: "Machine Learning Class Projects",
    description: "Advanced ML models implementing Naive Bayes and linear classifiers (Logistic Regression, Perceptron) for sentiment analysis and binary classification with 90%+ accuracy.",
    image: null,
    tags: ["Python", "Machine Learning", "Naive Bayes", "TensorFlow"],
    demoUrl: "#",
    githubUrl: "https://github.com/anshpachauri23/Portfolio",
  },
  {
    ...
    description: "Full-stack CRUD platform for 200+ students built with Ruby on Rails and MySQL, reducing submission errors by 35% and improving query speeds by 2s/request.",
    image: null,
    tags: ["Ruby on Rails", "MySQL", "Full-Stack", "CRUD"],
    demoUrl: "#",
    githubUrl: "https://github.com/anshpachauri23/Portfolio",
  },
];
